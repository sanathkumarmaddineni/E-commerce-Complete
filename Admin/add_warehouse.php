...
<aside id="sidebar" class="column">
	...
	<h4 class="alert_info">Welcome To <strong>"Store"</strong> Admin Panel As: <?php echo "  ". "<font color='#f90'><big><b>".$login_session."</b></big></font>" ;?>  </h4>
...
?>
  ...
  <table class="tablesorter" cellspacing="0"> 
		...
		<thead>  <th Colspan="9">  Store Warehouse Data Table </th></thead>
		<thead>
		<thead>
			</tr>
   		    <th>Check ID</th> 
